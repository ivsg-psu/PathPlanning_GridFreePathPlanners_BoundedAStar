% script_test_fcn_BoundedAStar_streamlineFollowing
% Tests: fcn_BoundedAStar_streamlineFollowing
...
%    separate function
% -- fix bug where propagating the time for longer doesn't change distance
%    traveled
...
%% DEMO case: drop a point into a wind field and follow a streamline
fig_num = 10001;
titleString = sprintf('DEMO case: drop a point into a wind field and follow a streamline');
...
startPoint = [4 -6];
timeLength = 5;
trajectory = fcn_BoundedAStar_streamlineFollowing(startPoint, timeLength, windFieldX, windFieldY, windFieldU, windFieldV, (fig_num));
