% script_test_fcn_BoundedAStar_approximateTSPviaMerging
% Tests: fcn_BoundedAStar_approximateTSPviaMerging
...
%% TEST case: estimating path in circulating wind field, 6 goal points specified
figNum = 20001;
titleString = sprintf('TEST case: estimating path in circulating wind field, 6 goal points specified');
fprintf(1,'Figure %.0f: %s\n',figNum, titleString);
figure(figNum); clf;
