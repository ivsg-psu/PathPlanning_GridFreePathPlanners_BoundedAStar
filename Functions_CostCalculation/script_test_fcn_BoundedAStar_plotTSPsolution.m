% script_test_fcn_BoundedAStar_plotTSPsolution
% Tests: fcn_BoundedAStar_plotTSPsolution

% Revision history
% 2025_09_09 by S. Brennan, sbrennan@psu.edu
% - In script_test_fcn_BoundedAStar_plotTSPsolution:
...
figNum = 10001;
titleString = sprintf('DEMO case: plotting matched wind field, goal points specified');
