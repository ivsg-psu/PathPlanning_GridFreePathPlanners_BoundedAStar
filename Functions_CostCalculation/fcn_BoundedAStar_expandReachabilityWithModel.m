function [finalReachableSet, exitCondition, cellArrayOfExitInfo, newStates, varargout] = ...
    fcn_BoundedAStar_expandReachabilityWithModel(costRad, ...
    windFieldU, windFieldV, windFieldX, windFieldY, modelParams, varargin)
...
while 1==flagContinueExpansion
    ...
    if 1 == flagTimeVarying
        ...
        [reachableSet, thisCellArrayOfIntermediateCalculations, newStates] = fcn_BoundedAStar_reachabilityWithModel(...
                costRad, windFieldU, windFieldV, windFieldX, windFieldY, modelParams, (startPoints), (flagWindRoundingType), (-1));
        modelParams.Platform.TempState = newStates.desTemp;
        modelParams.Platform.MassState = newStates.desMass;
    end
    ...
    newStartPoints = fcn_BoundaryXP_checkBoundaries(startPointsSparse, boundingRegion, axisRange, keepOutZones);
