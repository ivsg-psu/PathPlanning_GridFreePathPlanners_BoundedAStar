function [vertices, edges, costgraph] = fcn_BoundedAStar_rrtWindGraph(windFieldU, windFieldV, x, y, n_nodes, start, finish, varargin)
...
% through. edges are not straight lines but instead trajectories between 
% nodes determined by an RRT* exploration method
%
% FORMAT:
...
% -- first write of function using fcn_BoundedAStar_generateWindGraphas
%    starter
%
% TO-DO
