% script_test_fcn_BoundedAStar_makeTriangularSurfelsFromFacets
% tests fcn_BoundedAStar_makeTriangularSurfelsFromFacets
...
%% DEMO case: create surfels based on timespace polytope vertices
fig_num = 10001;
titleString = sprintf('DEMO case: create surfels based on timespace polytope vertices');
