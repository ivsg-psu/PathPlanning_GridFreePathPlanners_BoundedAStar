function [xings] = fcn_Visibility_linePolytopeIntersections(xiP,yiP,xiQ,yiQ,xjP,yjP,D,di,num_int,polytopes)
% fcn_Visibility_linePolytopeIntersections finds polytope-path intersection 
% information
%
