function weight_matrix = fcn_BoundedAStar_makePotentialFieldWeightMatrix(vgraph, all_pts, integration_method)

% Revision History:
% 2025_07_17 - K. Hayes, kxh1031@psu.edu
% -- copied to new function from fcn_make_potential_field_weight_matrix to
