function time_space_polytopes_with_facets = fcn_BoundedAStar_makeFacetsFromVerts(time_space_polytopes)
...
% FORMAT:
%
% time_space_polytopes_with_facets = fcn_BoundedAStar_makeFacetsFromVerts(time_space_polytopes)
%
% INPUTS:
%
