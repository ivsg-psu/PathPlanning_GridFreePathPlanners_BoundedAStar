function [vgraph, cgraph, hvec, finish, all_pts] = fcn_BoundedAStar_createPhantomGoal(vgraph, cgraph, hvec, finish, all_pts)
...
%
% FORMAT:
% [vgraph, cgraph, hvec, finish, all_pts] = fcn_BoundedAStar_createPhantomGoal(vgraph, cgraph, hvec, finish, all_pts)
%
% INPUTS:
%
