% script_test_fcn_BoundedAStar_animateTimespacePathPlan
...
% script_test_fcn_Visibility_3dGraphGlobal as a starter
...
% make rgraph
start_with_ids = [all_pts(end-1, :) -1];
finish_with_ids = [all_pts(end, :) -1];
...
% create animation
fcn_BoundedAStar_animateTimespacePathPlan(start, finish, time_space_polytopes, route_dense, dt, [0 100], [0 100]);
