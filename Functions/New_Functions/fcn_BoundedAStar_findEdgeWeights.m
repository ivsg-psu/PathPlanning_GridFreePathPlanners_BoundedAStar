function [cost_matrix, visibility_matrix_original] = fcn_BoundedAStar_findEdgeWeights(polytopes, all_pts, gap_size)
    ...
    visibility_matrix = fcn_Visibility_clearAndBlockedPointsGlobal(polytopes,all_pts, gap_size);
