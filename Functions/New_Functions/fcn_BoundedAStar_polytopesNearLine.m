function [close_polytopes] = fcn_BoundedAStar_polytopesNearLine(start,finish,polytopes)
% fcn_BoundedAStar_polytopesNearLine find polytopes possibly 
...
%      close_polytopes=fcn_BoundedAStar_polytopesNearLine(start,finish,shrunk_polytopes);
%      fcn_BoundedAStar_plotPolytopes(shrunk_polytopes,100,'b-',2,[0 100 0 100],'square');
%      fcn_BoundedAStar_plotPolytopes(close_polytopes,100,'g-',2);
