function [all_pts, start, finish] = fcn_BoundedAStar_polytopesGenerateAllPtsTable(polytopes, start_xy, finish_xy)
...
%
% FORMAT:
% [all_pts, start, finish] = fcn_BoundedAStar_polytopesGenerateAllPtsTable(polytopes, start_xy, finish_xy)
%
%
% INPUTS:
%
