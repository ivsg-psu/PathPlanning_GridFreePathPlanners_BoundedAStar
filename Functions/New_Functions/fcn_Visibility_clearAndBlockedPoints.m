...
% fcn_Visibility_clearAndBlockedPoints determines whether the points in
...
%      [clear_pts,blocked_pts]=fcn_Visibility_clearAndBlockedPoints(shrunk_polytopes,start,finish);
%      fcn_BoundedAStar_plotPolytopes(shrunk_polytopes,[],'b-',2,[0 100 0 100],'square');
