...
%      xi = 2;
%      yi = 0;
%      TF1 = fcn_BoundedAStar_calculatePointsOnLines(x1,y1,x2,y2,xi,yi,acc)
%      plot(xi,yi,'bx','linewidth',1)
%      xi = 2+1e-8;
%      yi = 0;
%      TF2 = fcn_BoundedAStar_calculatePointsOnLines(x1,y1,x2,y2,xi,yi,acc)
%      plot(xi,yi,'rx','linewidth',1)
%      xi = 2+2e-8;
%      yi = 0;
%      TF3 = fcn_BoundedAStar_calculatePointsOnLines(x1,y1,x2,y2,xi,yi,acc)
%      plot(xi,yi,'gx','linewidth',1)
%      xi = -2;
%      yi = -1;
%      TF4 = fcn_BoundedAStar_calculatePointsOnLines(x1,y1,x2,y2,xi,yi,acc)
