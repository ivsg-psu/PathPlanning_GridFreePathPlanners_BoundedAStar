function [err,Apoly,Bpoly] = fcn_BoundedAStar_polytopePointsInPolytopes(A,B,polytopes,throw_error,varargin)
% fcn_BoundedAStar_polytopePointsInPolytopes see if point A or B is in one of the
% polytopes
%
% [ERR]=fcn_BoundedAStar_polytopePointsInPolytopes(A,B,POLYTOPES,THROW_ERROR,EDGE_CHECK)
% returns:
...
%      B.x = 5;
%      B.y = 5;
%      fcn_BoundedAStar_plotPolytopes(polytopes,101,'b-',2,[-6 6 -6 6],'square')
...
%    fcn_polytope_calculation_points_in_polytopes to follow library convention
