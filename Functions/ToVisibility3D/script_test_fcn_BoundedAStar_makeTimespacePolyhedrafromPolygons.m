% script_test_fcn_BoundedAStar_makeTimespacePolyhedrafromPolygons
% tests fcn_BoundedAStar_makeTimespacePolyhedrafromPolygons

% Revision history
% 2025_08_15 - K. Hayes, kxh1031@psu.edu
...
%% DEMO case: make polytope field into timespace polyhedra
fig_num = 10001;
titleString = sprintf('DEMO case: make polytope field into timespace polyhedra');
...
final_time = 20;
time_space_polytopes = fcn_BoundedAStar_makeTimespacePolyhedrafromPolygons(shrunk_polytopes, max_translation_distance, final_time, (fig_num));
