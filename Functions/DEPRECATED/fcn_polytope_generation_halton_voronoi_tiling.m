...
warning('fcn_polytope_generation_halton_voronoi_tiling is being deprecated. Use fcn_MapGen_generatePolysFromSeedGeneratorNames with ''haltonset'' input instead.');
...
for poly = 1:num_poly % pull each cell from the voronoi diagram
    ...
    if length(xv)>2 % at least 3 points in cell
        ...
        polytopes(poly-remove).cost = rand;
%         %%%%%%%%%% trouble shooting
