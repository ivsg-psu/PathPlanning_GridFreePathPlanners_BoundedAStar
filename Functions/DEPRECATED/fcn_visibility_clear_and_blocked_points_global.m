function [visibility_matrix, visibility_results] = fcn_visibility_clear_and_blocked_points_global(...
    polytopes, starts, finishes, varargin)
...
%
% FORMAT:
% visibility_matrix = fcn_visibility_clear_and_blocked_points_global(polytopes, starts, finishes, (is_concave))
%
% INPUTS:
...
% -- fixed argument listing errors in docstrings
