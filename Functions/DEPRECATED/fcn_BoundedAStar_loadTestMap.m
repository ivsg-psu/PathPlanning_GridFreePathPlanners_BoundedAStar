function [polytopes, starts, finishes, resolution_scale, length_cost_weights, navigated_portions] = fcn_BoundedAStar_loadTestMap(map_idx, varargin)

warning('on','backtrace');
warning(['fcn_BoundedAStar_loadTestMap is being deprecated. ' ...
    'Use fcn_MapGen_loadTestMap instead within the MapGen library.']);

% fcn_BoundedAStar_loadTestMap
%
