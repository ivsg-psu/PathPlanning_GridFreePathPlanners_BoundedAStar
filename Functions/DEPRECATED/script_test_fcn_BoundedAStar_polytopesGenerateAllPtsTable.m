% script_test_fcn_BoundedAStar_polytopesGenerateAllPtsTable.m
% tests fcn_BoundedAStar_polytopesGenerateAllPtsTable.m
...
%% DEMO case: call function to generate all_pts matrix
fig_num = 10001;
titleString = sprintf('DEMO case: call function to generate all_pts matrix');
