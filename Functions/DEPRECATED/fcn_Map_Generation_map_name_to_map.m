...
warning('fcn_Map_Generation_map_name_to_map is being deprecated. Use fcn_MapGen_generatePolysFromName instead.');
...
% 
% [POLYTOPES,fig]=FCN_MAP_GENERATION_MAP_NAME_TO_MAP(MAP_NAME,PLOT_FLAG, DISP_NAME, FIG_NUM,LINE_SPEC,LINE_WIDTH,COLOR,AXIS_LIMITS,AXIS_STYLE,FILL_INFO)
% returns: 
