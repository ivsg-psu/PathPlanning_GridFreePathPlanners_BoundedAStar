...
figure(fig_num)
hold on
fcn_MapGen_plotPolytopes(shrunk_polytopes,plotFormat,[1 0 0 0 0.1],fig_num)
...
% add a polytope
addPolytope = shrunk_polytopes(4);
addPolytope.xv = addPolytope.xv + 100;

[vgraphNew, all_ptsNew, startNew, finishNew, polytopesNew] = fcn_Visibility_addObstacle(...
    vgraph, all_pts, [], [], shrunk_polytopes, addPolytope);
...
fig = 9999; % figure to plot on
    ...
    fcn_MapGen_plotPolytopes(polytopesNew,'b',[1 0 0 0 0.1],fig_num);
    line_spec = 'r--'; % edge line plotting
    fcn_MapGen_plotPolytopes(addPolytope,'-r',[1 0 0 0 0.1],fig_num);
