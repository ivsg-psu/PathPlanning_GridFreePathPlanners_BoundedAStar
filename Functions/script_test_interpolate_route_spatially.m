...
plot(start_midway(1),start_midway(2),'dm', 'LineWidth', 2,'MarkerSize',2)
title_string = sprintf('interpolating a %i point route \n to form a %i point route', size(init_route,1), num_pts_dense);
title(title_string);
legend('start','finish','initial route','interpolated route');
