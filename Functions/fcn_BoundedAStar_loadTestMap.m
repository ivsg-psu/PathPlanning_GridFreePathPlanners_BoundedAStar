function [polytopes, starts, finishes, resolution_scale, length_cost_weights, navigated_portions] = ...
    fcn_BoundedAStar_loadTestMap(map_idx, varargin)
...
% -- explicitly put deprecation warning on fcn_util_load_test_map
% -- search/replace for fcn_util_load_test_map to remove usage in library
