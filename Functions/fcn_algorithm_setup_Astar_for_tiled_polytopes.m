function [path,cost,err] = fcn_algorithm_setup_Astar_for_tiled_polytopes(polytopes,A,B,planner_mode,varargin)
...
%     fcn_polytope_editing_tiling_loop_polytopes(polytopes);
    ...
    [vgraph, visibility_results_all_pts] = fcn_visibility_clear_and_blocked_points_global(polytopes, starts, finishes);
    %% calculate path
