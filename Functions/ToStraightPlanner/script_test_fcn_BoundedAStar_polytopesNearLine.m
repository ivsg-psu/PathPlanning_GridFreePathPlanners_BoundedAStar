% script_test_fcn_BoundedAStar_polytopesNearLine.m
% tests fcn_BoundedAStar_polytopesNearLine.m
...
%% DEMO case: show polytopes close to/intersected by straight line
fig_num = 10001;
titleString = sprintf('DEMO case: show polytopes close to/intersected by straight line');
...
% Call close polytope detector
close_polytopes=fcn_BoundedAStar_polytopesNearLine(start,finish,shrunk_polytopes, (fig_num));
