% script_test_fcn_BoundedAStar_calculatePointToLineDistSquared
% tests fcn_BoundedAStar_calculatePointToLineDistSquared
...
vert1 = [0 0 0];
vert2 = [10 10 10];
dist_sq = fcn_BoundedAStar_calculatePointToLineDistSquared(pt,vert1,vert2,fig_num);


sgtitle(titleString, 'Interpreter','none');

% Check variable types
assert(isnumeric(dist_sq));

% Check variable sizes
Npoints = 3;
assert(isequal(Npoints,length(dist_sq))); 
