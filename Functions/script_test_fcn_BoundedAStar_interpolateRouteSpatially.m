% script_test_fcn_BoundedAStar_interpolateRouteSpatially

% a basic test of 2D spatial route interpolation

% Revision History:
% 2024_01 by S. Harnett
% -- first write of script
% 2025_08_11 - K. Hayes, kxh1031@psu.edu
% -- copied example into new script 
% -- updated formatting
...
%% DEMO case: interpolate a path between waypoints
fig_num = 10001;
titleString = sprintf('DEMO case: interpolate a path between waypoints');
...
route_dense = fcn_BoundedAStar_interpolateRouteSpatially(init_route, desired_spacing, fig_num);
...
assert(isnumeric(route_dense));

% Check variable sizes
assert(size(route_dense,1)==118);
assert(size(route_dense,2)==2);
